		...
		Pass
		{
			...
			fixed4 frag (Water2D_VertexOutput i) : SV_Target
			{
				...
				//Applying light
					...
					finalColor.rgb *= i.lightColor + _WaterEmissionColor * _WaterEmissionColorIntensity;
				#else
	...
	Pass
		{
			...
			fixed4 frag (Water2D_VertexOutput i) : SV_Target
			{
				...
				//Applying light
				#if defined(Water2D_ApplyEmissionColor)
					finalColor.rgb *= (i.lightColor + DecodeLightmap(UNITY_SAMPLE_TEX2D(unity_Lightmap, i.lightmapCoord))) + _WaterEmissionColor * _WaterEmissionColorIntensity;
				#else
